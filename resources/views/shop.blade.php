                ...
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="shop_sidebar_area">
                        ...
                        <div class="widget catagory mb-50">
                            <!-- Widget Title -->
                            <h6 class="widget-title mb-30">Catagory</h6>
                                    ...
                                    <div class="product-description">
                                        ...
                                        <div class="hover-content">
                                            ...
                                            <div class="add-to-cart-btn">
                                                 @if ($catalog->id == 'customid')
                                                 <a href="\customdesign" class="btn essence-btn">Add sto Cart</a>
                                                @else
                                                <a href="\product\show\{{$catalog->id}}" class="btn essence-btn">Add sto Cart</a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
