...
class Product extends Model
{
    ...
    {
        return $this->belongsToMany('App\Models\Category', 'shop_categories_products', 'product_id', 'category_id'); //phpcs:ignore
    }

    public function tags()
    {
        return $this->belongsToMany('App\Models\Tag', 'shop_products_tags', 'product_id', 'tag_id');
    }
